function [sequencewise_table] = mpii_evaluate_multiperson_errors(sequencewise_error)

joint_groups = mpii_get_pck_auc_joint_groups()
[~,~,~,joint_names] = mpii_get_joints('relevant');
num_joints = 14; %Consider only the LSP compatible joints
joint_names = joint_names(1:num_joints);
all_errors = [];
sequencewise_pck = {};
sequencewise_auc = {};
